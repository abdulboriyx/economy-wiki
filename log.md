## [2026-04-07] ingest | An Inquiry into the Nature and Causes of the Wealth of Nations

**Source:** Adam Smith (1776) — `raw/Wealth-Nations.pdf`

Pages created:
- `wiki/sources/wealth-of-nations.md` — full source summary
- `wiki/economists/adam-smith.md` — economist profile
- `wiki/theories/division-of-labour.md`
- `wiki/theories/invisible-hand.md`
- `wiki/theories/absolute-advantage.md`
- `wiki/concepts/value-in-use-vs-value-in-exchange.md`
- `wiki/concepts/natural-vs-market-price.md`
